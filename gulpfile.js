...
gulp.task('rename', function ()  {
    var newname;
    var author = 'Fabian Siebold';
    var email  = 'fabian.siebold@gmail.com';
    ...
    if (!newname) {
        console.log('Please write the new bacnet name, like: "gulp rename --name mywidgetset" --author "Fabian Siebold"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/bacnet.png')) {
        fs.renameSync(__dirname + '/admin/bacnet.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/bacnet.html')) {
        fs.renameSync(__dirname + '/widgets/bacnet.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/bacnet/js/bacnet.js')) {
        fs.renameSync(__dirname + '/widgets/bacnet/js/bacnet.js', __dirname + '/widgets/bacnet/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/bacnet')) {
        fs.renameSync(__dirname + '/widgets/bacnet',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /bacnet/g,
        ...
        {
            match: /Bacnet/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Bacnet'
        },
        {
            match: /Fabian Siebold/g,
            replacement: author
        },
        {
            match: /fabian.siebold@gmail.com/g,
            replacement: email
        }
    ];
    var files = [
